...
class Utilisateur
{
    ...
    public function setMotDePasse(string $mot_de_passe, bool $encrypted = true): self
    {
        $this->mot_de_passe = $encrypted ? password_hash($mot_de_passe, PASSWORD_DEFAULT) : $mot_de_passe;
